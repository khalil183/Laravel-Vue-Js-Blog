                ...
                <div class="box-body">
                    <form @submit.prevent="updatePost">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" @change="loadImage($event)" :class="{ 'is-invalid': form.errors.has('updateImage') }">
                            <has-error :form="form" field="updateImage"></has-error>
                            <img width="100px" :src="form.updateImage" alt="">
                        </div>
...
export default {
    ...
    methods:{
        ...
        updatePost(){
            this.form.put('/api/blog/'+this.$route.params.id,this.form)
                .then(response=>{
        ...
        loadImage(event){
            ...
            reader.onload = evt=>{
                this.form.updateImage=evt.target.result
            }
