<template>
  <div>
        ...
        <!-- Blog Post -->
        <div class="card mb-4" v-for="(post,i) in posts" :key="i" v-show="post.category_id== category">
          <img class="card-img-top" :src="`http://127.0.0.1:8000/${post.image}`" alt="Card image cap">
          <div class="card-body">
